...
func (s *SkupperComponentHandlerPodman) Get(name string) (v2.SkupperComponent, error) {
...
func (s *SkupperComponentHandlerPodman) List() ([]v2.SkupperComponent, error) {
