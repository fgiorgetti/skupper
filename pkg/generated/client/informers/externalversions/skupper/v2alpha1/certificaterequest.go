...
type CertificateRequestInformer interface {
	...
	Lister() skupperv2alpha1.CertificateRequestLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SkupperV2alpha1().CertificateRequests(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SkupperV2alpha1().CertificateRequests(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SkupperV2alpha1().CertificateRequests(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SkupperV2alpha1().CertificateRequests(namespace).Watch(ctx, options)
			},
		},
		&apisskupperv2alpha1.CertificateRequest{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *certificateRequestInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisskupperv2alpha1.CertificateRequest{}, f.defaultInformer)
}

func (f *certificateRequestInformer) Lister() skupperv2alpha1.CertificateRequestLister {
	return skupperv2alpha1.NewCertificateRequestLister(f.Informer().GetIndexer())
}
